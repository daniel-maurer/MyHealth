...
export class MessageService extends BaseService {
  ...
  create(
    message: Message,
    listMessages: AngularFireList<Message>
  ...
  getMessages(userId1: string, userId2: string): AngularFireList<Message> {
    ...
    return this.db.list(`/messages/${userId1}-${userId2}`, (ref: firebase.database.Reference) =>
      ref.limitToLast(30).orderByChild('timestamp')
    );
  }
}
